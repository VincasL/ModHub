...
namespace ModHub.Authentication
{
    public class JwtAuthManager : IJwtAuthManager
    {
        ...
        public JwtAuthResult GenerateTokens(string email, Claim[] claims, DateTime now)
        {
            ...
            _usersRefreshTokens.AddOrUpdate(refreshToken.TokenString, refreshToken, (str, token) => refreshToken);
        ...
        public JwtAuthResult Refresh(string refreshToken, string accessToken, DateTime now)
        {
            ...
            if (existingRefreshToken.Email != userName || existingRefreshToken.ExpireAt < now)
            {
                throw new SecurityTokenException("Invalid token");
            }
        ...
        public (ClaimsPrincipal, JwtSecurityToken) DecodeJwtToken(string token, bool validateTokenExpiration = true)
        {
